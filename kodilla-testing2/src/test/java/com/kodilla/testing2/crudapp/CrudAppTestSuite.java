...
public class CrudAppTestSuite {
    private static final String BASE_URL = "https://mwojtyla.github.io/";
    ...
    private boolean checkTaskExistsInTrello(String taskName) throws InterruptedException {
        ...
        driverTrello.findElement(By.id("user")).sendKeys("martyna.wojtyla@gmail.com");
        driverTrello.findElement(By.id("login")).submit();

        Thread.sleep(4000);

        driverTrello.findElement(By.id("password")).sendKeys("MW89-kodilla");
